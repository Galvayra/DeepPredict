...
python training.py -id reverse -w2v 1 -epoch 20000 -hidden 0 > result/h_00_ep_20000_w2v
...
python training.py -id reverse -w2v 1 -epoch 10000 -hidden 1 > result/h_00_ep_10000_w2v
...
python training.py -id reverse -w2v 1 -epoch 5000 -hidden 2 > result/h_00_ep_5000_w2v
