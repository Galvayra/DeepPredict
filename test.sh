...
echo "h_00_ep_w2v"
echo
python training.py -id new -epoch 20000 -hidden 0 -w2v 0 -dir h_00_ep_20000_w2v_0 > result/h_00_ep_20000_w2v_0_runtime
...
echo "h_01_ep_w2v"
echo
python training.py -id new -epoch 10000 -hidden 1 -w2v 0 -dir h_01_ep_10000_w2v_0 > result/h_01_ep_10000_w2v_0_runtime
...
echo "h_02_ep_w2v"
echo
python training.py -id new -epoch 10000 -hidden 2 -w2v 0 -dir h_02_ep_10000_w2v_0 > result/h_02_ep_10000_w2v_0_runtime
